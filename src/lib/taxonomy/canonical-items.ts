...
export const CANONICAL_ITEMS: readonly CanonicalItem[] = [
  ...
  { slug: 'shrimp_lb', displayName: 'Shrimp', category: 'seafood', businessCategory: G, comparableUnit: 'lb',
    aliases: ['shrimp', 'raw shrimp', 'cooked shrimp', 'jumbo shrimp', 'shrimp ring'] , unitPriceRange: [4, 40], excludes: ['seasoning', 'sauce', 'chips', 'flavored'] },
  ...
  { slug: 'avocado', displayName: 'Avocado', category: 'produce', businessCategory: G, comparableUnit: 'each',
    aliases: ['avocado', 'avocados', 'hass avocado'] , unitPriceRange: [0.3, 4], excludes: ['oil', 'dip', 'guacamole', 'toast'] },
  ...
  { slug: 'berries_lb', displayName: 'Blueberries / raspberries', category: 'produce', businessCategory: G, comparableUnit: 'lb',
    aliases: ['blueberries', 'raspberries', 'blackberries', 'pint of blueberries', 'berries'] , unitPriceRange: [2, 25], excludes: ['jam', 'preserve', 'juice', 'syrup', 'yogurt', 'cereal', 'muffin'] },
